	...
	public List<Service> searchById(int id, String scope) {
		...
		try {
			...
			if (scope != null) {
				...
				if (id == 0) {
					statement = connection.prepareStatement(Constants.GETSERVICESQUERYBYSCOPE);

					statement.setBoolean(1, scope.equals("r1"));
					resultSet = statement.executeQuery();
				} else {
				...
				while (resultSet.next()) {
					service = new Service(resultSet.getString("source_inventory"), resultSet.getString("interfacename"),
							resultSet.getString("description"), resultSet.getString("interface_category"),
							resultSet.getString("business_function"), resultSet.getString("business_process"),
							resultSet.getString("segment"), resultSet.getString("lob"),
							resultSet.getString("entities_exchange"), resultSet.getString("connection_method"),
							resultSet.getString("transport"), resultSet.getString("connection_frequency"),
							resultSet.getString("data_format"), resultSet.getString("provider_technology"),
							resultSet.getString("r1_disposition"), resultSet.getString("r2_disposition"),
							resultSet.getString("asynch_synch"), resultSet.getString("service_provider"),
							resultSet.getString("pattern"), resultSet.getString("interface_complexity"),
							resultSet.getString("provider_detail"), resultSet.getString("steel_thread"),
							resultSet.getString("modified_comment"), resultSet.getDate("last_modification"),
							resultSet.getInt("id"), resultSet.getBoolean("scope"));
